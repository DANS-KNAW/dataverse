...
public class FastGetRecord {
    ...
    protected static final String XML_XMLNS_XSI_ATTRIBUTE_TAG = "xmlns:xsi=";
    protected static final String XML_XMLNS_XSI_ATTRIBUTE = " "+XML_XMLNS_XSI_ATTRIBUTE_TAG+"\"http://www.w3.org/2001/XMLSchema-instance\">";
